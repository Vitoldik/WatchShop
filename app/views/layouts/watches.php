                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <?php if (!empty($_SESSION['user'])): ?>
                                <li>
                                    <a href="#">Welcome, <?= escapeSpecialChars($_SESSION['user']['name']) ?></a>
                                </li>
                                <li>
...
<!--start-logo-->
<div class="logo">
    <a href="<?= MAIN_URL ?>"><h1>Luxury Watches</h1></a>
</div>
<!--start-logo-->
<!--bottom-header-->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger btn-clear-cart">Очистить корзину</button>
            </div>
        </div>
    </div>
</div>
